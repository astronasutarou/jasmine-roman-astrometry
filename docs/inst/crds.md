...
- [`roman_0066.pmap`](https://roman-crds.stsci.edu/context_table/roman_0066.pmap) (STScI, Activation: 2026-09-19)
- [`roman_wfi_bam_0004.rmap`](https://roman-crds.stsci.edu/browse/roman_wfi_bam_0004.rmap) (STScI, Delivery/Activation: 2026-09-19)
...
```bash
export CRDS_CONTEXT=roman_0066.pmap
```
...
Roman CRDS では 2026-09-16 から 2026-09-19 にかけて, WFI Boresight Alignment Matrix (BAM) が軌道上 commissioning データに基づいて更新された.
...
2026-09-22 時点では `roman_0066.pmap` が `latest` であり, BAM の RMAP は `roman_wfi_bam_0004.rmap` である. この RMAP の `USEAFTER` は `2026-09-01 00:00:00` で, それ以降の exposure に `roman_wfi_bam_0003.asdf` を選択する. CRDS は両更新の change level を `SEVERE` としている.
